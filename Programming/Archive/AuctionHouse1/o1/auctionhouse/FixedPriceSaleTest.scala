...
object FixedPriceSaleTest extends App {
  ...
  val bookSale = new FixedPriceSale("Programming in Scala, 2nd Ed", 30, 4)
  ...
  // Voluntary additional exercise: create a function that prints out the 
  // information about the book sale and card sale, so that all the println 
  // commands don't have to be repeated.
