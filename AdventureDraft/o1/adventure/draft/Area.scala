...
class Area(var name: String, var description: String) {
  ...
  /** the area that is reached by exiting up from this area; `None` if there is no westwardly exit */
  var upNeighbor: Option[Area] = None
  /** the area that is reached by exiting down from this area; `None` if there is no westwardly exit  */
  var downNeighbor: Option[Area] = None
