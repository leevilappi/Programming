...
class TribalRobotWindow extends RobotWindow {  
  ...
  override protected def createView(world: RobotWorld) = new TribalView(this, world)
  ...
  protected class TribalView(parent: TribalRobotWindow, world: RobotWorld) extends RobotsView(parent, world) {
